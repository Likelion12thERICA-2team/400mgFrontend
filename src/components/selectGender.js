        ...
        <section className="mt-[26px] mb-[32px] flex flex-col justify-start px-[20px]">
            ...
            <div className="flex flex-row gap-[11px] mt-[10px]">
                <div onClick={() => handleSelection('남자')}>
                    <Round10Button backgroundColor={"#EBEBEB"} color={"black"} content={"남자"} />
                </div>
                <div onClick={() => handleSelection('여자')}>
                    <Round10Button backgroundColor={"#EBEBEB"} color={"black"} content={"여자"} />
                </div>
                <div onClick={() => handleSelection('기타')}>
                    <Round10Button backgroundColor={"#EBEBEB"} color={"black"} content={"기타"} />
                </div>
            </div>
            ...
            (
                <>
                    <div className={ showBodyinfo ? "mt-[255px]" : (showBirthdate ? "mt-[366px]" : "mt-[481px]")}>
                        <Button 
