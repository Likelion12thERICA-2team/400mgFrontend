...
const State = () => {
    ...
    const getBottom = () => {
        switch (num) {
            ...
            case 6:
                return ( <> 권장량보다 많이 섭취했어요. <span className="text-[#FF3B30]">하루 정도</span> 안정을 취해주세요 </> ); // 한계
            default:
    ...
    return (
        <>
            ...
            <section className="flex justify-start">
                <div className="h-[812px] w-[375px] relative overflow-hidden"  style={{backgroundColor : bgColor}}>
                    ...
                    <div className="relative w-[375px] h-[396px] bg-[#FFFFFF] rounded-t-[30px] mt-[46px]">
                        ...
                        >
                            ...
                            <div className="flex justify-center itme-center">
                                <button className="bg-[#A198F6] w-[189px] h-[44px] rounded-[30px]" onClick={toggleBox}>
                    ...
                    <div 
                        className={`absolute inset-0  bg-black
                            ...
                            ${isBoxVisible ? 'opacity-50' : 'opacity-0 pointer-events-none'}
                            ${isRecordVisible ? 'opacity-50' : 'opacity-0 pointer-events-none'}`}
                    >
                    </div>
